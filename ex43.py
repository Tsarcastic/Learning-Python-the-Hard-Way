...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        print "escape pod."
        print "\n"
        print "You're running down the central corridor to the Weapons Armoy when"
        ...
        if action == "1":
            ...
            print"Lbhe zbgure vf jndn non dwodij iwdn iwdndwin."
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        else: "The lock buzzes one last time and then you hear a sickening"
...
class TheBridge(Scene):
    def enter(self):
        ...
        print "arm and doesn't want to set it off."
        ...
        if action == "1":
            ...
            print "the bomb. You die knowing they will probably blow up whe"
            print "it goes off."
            return 'death'
        elif action == "2":
...
class EscapePod(Scene):
    def enter(self):
        ...
        print "now need to pick one up to take. Some of them could be damage"
